...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float space1 = paint1.measureText(text1);
        float space2 = paint2.measureText(text2);
        canvas.drawText(text1, 50, 200, paint1);
        canvas.drawText(text2, 50 + space1, 200, paint2);
        canvas.drawText(text3, 50 + space1 + space2, 200, paint1);
    }
}
